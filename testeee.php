...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['action']) && $_POST['action'] == 'form_submit') {
    ...
    $sql = "INSERT INTO envio_farinha (nome, fornecedores, entregador, numero_romaneio, data, peso_ova, saca_ova, peso_torrada, saca_torrada, peso_file, saca_file, lotes, quantidade_sacas, peso_total) 
            VALUES ('$nome', '$fornecedores', '$entregador', '$numero_romaneio', '$data', '$peso_ova', '$saca_ova', '$peso_torrada', '$saca_torrada', '$peso_file', '$saca_file', '$lotes', '$quantidade_sacas', '$peso_total')";
                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="recebimento.php">Recebimento de Farinha</a>
                                <a class="nav-link" href="envio.php">Envio de Farinha</a>
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="peso_ova" name="peso_ova" readonly>
                    </div>
                    <div class="form-group">
                        <label for="saca_ova">Saca da Ova (kg)</label>
                        <input type="text" class="form-control" id="saca_ova" name="saca_ova" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="peso_torrada" name="peso_torrada" readonly>
                    </div>
                    <div class="form-group">
                        <label for="saca_torrada">Saca da Torrada (kg)</label>
                        <input type="text" class="form-control" id="saca_torrada" name="saca_torrada" readonly>
                    </div>
                    <div class="form-group">
                        <label for="peso_file">Peso do File (kg)</label>
                        <input type="text" class="form-control" id="peso_file" name="peso_file" readonly>
                    </div>
                    <div class="form-group">
                        <label for="saca_file">Saca do File (kg)</label>
                        <input type="text" class="form-control" id="saca_file" name="saca_file" readonly>
                    </div>
                    <div class="form-group">
                        <label for="lotes">Lote</label>
                        <input type="text" class="form-control" id="lotes" name="lotes" readonly>
                    </div>
                    <div class="form-group">
                        <label for="quantidade_sacas">Quantidade de Sacas</label>
                        <input type="text" class="form-control" id="quantidade_sacas" name="quantidade_sacas" readonly>
                    </div>
                    <div class="form-group">
